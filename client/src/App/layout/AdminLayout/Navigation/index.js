...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.original.preLayout,
        collapseMenu: state.original.collapseMenu,
        layoutType: state.original.layoutType,
        navBackColor: state.original.navBackColor,
        navBackImage: state.original.navBackImage,
        navIconColor: state.original.navIconColor,
        navBrandColor: state.original.navBrandColor,
        layout6Background: state.original.layout6Background,
        layout6BackSize: state.original.layout6BackSize,
        rtlLayout: state.original.rtlLayout,
        navFixedLayout: state.original.navFixedLayout,
        boxLayout: state.original.boxLayout,
        navDropdownIcon: state.original.navDropdownIcon,
        navListIcon: state.original.navListIcon,
        navActiveListColor: state.original.navActiveListColor,
        navListTitleColor: state.original.navListTitleColor,
        navListTitleHide: state.original.navListTitleHide
    };
};
